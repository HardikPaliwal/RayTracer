...
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 6.666)
mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 6.666)
mat4 = gr.material({0.7, 0.6, 1.0}, {0.5, 0.4, 0.8}, 6.666)
...
gr.render(scene_root, 'nonhier.png', 712, 712,
